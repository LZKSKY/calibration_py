...
def cal1():
    ...
    ret_l, mtx_l, dist_l, rvecs_l, tvecs_l = get_parate(images_left, w, h)
    ret_r, mtx_r, dist_r, rvecs_r, tvecs_r = get_parate(images_right, w, h)

    # R = np.array(rvecs_r) - np.array(rvecs_l)
